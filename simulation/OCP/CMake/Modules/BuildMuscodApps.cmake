...
FUNCTION( ADD_MUSCOD_APP _LIB _SOURCES _DEPS  )
	IF( ARGC GREATER 3 )
...
#		INSTALL_RPATH ${INSTALL_LIBRARY_DIR} # find also libs from this package
	...
	IF( NOT "${COMPILE_FLAGS}" STREQUAL "" )
		SET_TARGET_PROPERTIES( "${_LIB}" PROPERTIES COMPILE_FLAGS "${COMPILE_FLAGS}" )
	ENDIF()
...
FUNCTION( PREPARE_MUSCOD_APP_BUILD _SDIR _TDIR )
	IF( NOT IS_DIRECTORY "${_SDIR}" )
		ERROR( "PREPARE_MUSCOD_APP_BUILD(): Cannot read from '${_SDIR}', not a directory." )
	ENDIF()
	IF( NOT IS_DIRECTORY "${_TDIR}" )
		ERROR( "PREPARE_MUSCOD_APP_BUILD(): Cannot write to '${_TDIR}', not a directory." )
	ENDIF()
