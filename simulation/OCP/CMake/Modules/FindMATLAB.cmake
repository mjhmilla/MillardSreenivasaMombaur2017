...
FIND_LIBRARY( MATLAB_MX_LIBRARY  "${MX_NAME}"
	PATHS ${MATLAB_LIBRARY_SEARCH_DIRS}
	PATH_SUFFIXES lib  lib64 LIB
	NO_SYSTEM_ENVIRONMENT_PATH     # hack to avoid finding /usr/lib/libmx.dylib on MacOS, which is not Matlab's libmx.
	NO_CMAKE_SYSTEM_PATH           # hack to avoid finding /usr/lib/libmx.dylib on MacOS, which is not Matlab's libmx.
)
...
IF( MATLAB_FOUND )
	...
	SET(CMAKE_EXTRA_INCLUDE_FILES ${MATLAB_INCLUDE_DIR}/tmwtypes.h)
