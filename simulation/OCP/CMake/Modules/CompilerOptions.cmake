...
IF( BUILD_32BIT )
	...
	# BUILD_32BIT is optional on 64bit machines and here -m32 important!
 	ADD_DEFINITIONS( -m32 )
# 	SET( CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -frecursive" CACHE STRING "" )
ELSE ( BUILD_32BIT )
# 	SET( CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -fdefault-integer-8 -frecursive" CACHE STRING "" )
ENDIF()
...
#
#
# SET( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -pthread" CACHE STRING "" )
